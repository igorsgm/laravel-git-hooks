...
test(
    'Get Log', function (string $logText) {
        $log = new Log($logText);
...
test(
    'Parse default Git log from Console', function (string $logText) {
        $log = new Log($logText);
...
test(
    'Parse Merge Git log from Console', function (string $logText) {
        $log = new Log($logText);
...
test(
    'Returns Hash when parsed to string', function (string $logText) {
        $log = new Log($logText);
