...
it(
    'Handles invalid hook types', function () {
        $this->artisan(
            'git-hooks:make', [
                'hookType' => 'invalid',
                'name' => 'InvalidHook',
...
test(
    'Generates a hook file with a valid hook type', function () {
...
test(
    'Does not overwrite existing hook file', function () {
...
test(
    'Uses custom stub if available', function () {
...
test(
    'prompts for missing arguments and creates hook', function () {
